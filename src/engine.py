...
from src.entities import (
    ...
    GROUND_Y, C, LEVEL_LENGTH, SCREEN_W, SCREEN_H, TOTAL_STARS
)
...
class GameEngine:
    ...
    def _generate_level(self, seed=42):
        ...
        # Platforms + elevated coins (max 145px so player can reach)
        px = 200
        while px < LEVEL_LENGTH - 300:
            pw = rng.randint(120, 220)
            ph_offset = rng.randint(80, 145)
